...
def print_connection_check_results(domain: str, datasource_results: dict[DatasourceId, CheckDatasourceConnectionResult]):
    for datasource_id, result in datasource_results.items():
        fq_datasource_name = domain + os.pathsep + str(datasource_id)
