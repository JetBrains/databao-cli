...
def render_welcome_page() -> None:
    ...
    from databao_cli.features.ui.app import _create_new_chat
...
def render_setup_wizard_page() -> None:
    ...
    """
    from databao_cli.features.ui.app import _create_new_chat, is_hide_build_context_hint, is_read_only_domain
    from databao_cli.features.ui.components.datasource_manager import render_datasource_manager
    from databao_cli.features.ui.services.build_service import (
        get_build_status,
        render_build_section,
    )
    from databao_cli.features.ui.services.dce_operations import init_project, list_datasources
    ...
    with col2:
        ...
        if not has_datasources:
            ...
            if st.button("Start New Chat", key="setup_start_chat", type="primary"):
                from databao_cli.features.ui.app import mark_welcome_completed
