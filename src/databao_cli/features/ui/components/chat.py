...
from databao_cli.features.ui.components.results import render_execution_result
from databao_cli.features.ui.models.chat_session import ChatMessage
from databao_cli.features.ui.services import (
...
from databao_cli.features.ui.suggestions import (
...
def render_chat_interface(chat: "ChatSession") -> None:
    ...
    if "pending_plot_message_index" in st.session_state:
        from databao_cli.features.ui.components.results import execute_pending_plot
