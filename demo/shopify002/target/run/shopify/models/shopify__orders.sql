    ...
    create  table
      "shopify"."main"."shopify__orders__dbt_tmp"
...
with refunds as (
    ...
    select *
    from "shopify"."main_stg_shopify"."stg_shopify__order_line_refund"
...
from refund_join
    ...
    select *
    from "shopify"."main_stg_shopify"."stg_shopify__order_adjustment"
 ...
 as order_tags
    ...
    from "shopify"."main_stg_shopify"."stg_shopify__order_tag"
    group by 1,2
