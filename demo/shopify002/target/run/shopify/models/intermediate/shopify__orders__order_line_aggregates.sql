    ...
    create  table
      "shopify"."main"."shopify__orders__order_line_aggregates__dbt_tmp"
...
from aggregated
    ...
    select *
    from "shopify"."main_stg_shopify"."stg_shopify__order_line"

), tax as (

    select
        *
    from "shopify"."main_stg_shopify"."stg_shopify__tax_line"
